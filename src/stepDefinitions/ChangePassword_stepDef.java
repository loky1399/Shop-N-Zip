...
public class ChangePassword_stepDef {
	...
	public void i_should_be_able_to_see_these_fields_in_page(DataTable arg1)
			throws Throwable {
		// Write code here that turns the phrase above into concrete actions
	...
	@Then("^'submit' button should not be enabled\\.$")
	public void submit_button_should_not_be_enabled() throws Throwable {
		// Write code here that turns the phrase above into concrete actions
		throw new PendingException();
	}
	...
	public void i_should_be_able_to_change_my_password_with_confirmation_message_Your_password_has_been_changed_successfully_please_loggin_with_your_new_password_on_my_screen()
			throws Throwable {
		// Write code here that turns the phrase above into concrete actions
		throw new PendingException();
	}

	@Then("^I should be able to redirected on loggin page\\.$")
	public void i_should_be_able_to_redirected_on_loggin_page()
			throws Throwable {
		// Write code here that turns the phrase above into concrete actions
		throw new PendingException();
	}
	...
	public void i_should_see_error_message_Current_password_is_wrong()
			throws Throwable {
		// Write code here that turns the phrase above into concrete actions
		throw new PendingException();
	}
	...
	public void i_should_see_error_message_Enter_new_password()
			throws Throwable {
		// Write code here that turns the phrase above into concrete actions
		throw new PendingException();
	}
	...
	public void i_should_see_message_Enter_your_current_password()
			throws Throwable {
		// Write code here that turns the phrase above into concrete actions
		throw new PendingException();
	}
	...
	public void i_shouldsee_message_Please_retype_your_new_password()
			throws Throwable {
		// Write code here that turns the phrase above into concrete actions
		throw new PendingException();
	}
	...
	public void i_should_message_Re_type_new_password_should_be_matched_to_new_password()
			throws Throwable {
		// Write code here that turns the phrase above into concrete actions
		throw new PendingException();
	}
