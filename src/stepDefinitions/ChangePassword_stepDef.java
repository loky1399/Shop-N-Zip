...
public class ChangePassword_stepDef {
	...
	public void i_click_on_Edit_profile_link() throws Throwable {
		// Write code here that turns the phrase above into concrete actions
		try {
			Assert.assertTrue(pageObjects.MyProfile.EditProfileLinkText(driver)
					.isDisplayed());
	...
	public void click_on_change_password_link() throws Throwable {
		// Write code here that turns the phrase above into concrete actions
		try {
			Assert.assertTrue(pageObjects.MyProfile
					.ChangePasswordLinkInEditProfile(driver).isDisplayed());
			pageObjects.MyProfile.ChangePasswordLinkInEditProfile(driver)
					.click();
		} catch (Exception e) {
	...
	public void i_should_see_change_password_section() throws Throwable {
		try {
			Assert.assertTrue(pageObjects.ChangePassword.ChangePasswordSection(
					driver).isDisplayed());
		} catch (Exception e) {
			System.out.println(e);
	...
	public void i_should_see_Change_Password_as_title() throws Throwable {
		try {
			String actual = pageObjects.ChangePassword.CahngePasswordHeading(
					driver).getText();
	...
	public void i_should_be_able_to_see_these_fields_in_page(
			DataTable fieldChangePassword) throws Throwable {
		List<List<String>> field = fieldChangePassword.raw();

		try {
			Assert.assertTrue(pageObjects.ChangePassword
					.CurrentPasswordTextBox(driver).isDisplayed()
					&& pageObjects.ChangePassword.EnterANewPasswordtextBox(
							driver).isDisplayed()
					&& pageObjects.ChangePassword.RetypePasswordtextfield(
							driver).isDisplayed()
					&& pageObjects.ChangePassword.ChangePaaswordSubmiteButton(
							driver).isDisplayed()
					&& pageObjects.ChangePassword.ChangePassWordBackButton(
							driver).isDisplayed());
		} catch (Exception e) {
			System.out.println(e);
	...
	public void i_entered_my_current_password_in_current_password_filed()
		...
		try {
			...
			Thread.sleep(1000);
			pageObjects.ChangePassword.CurrentPasswordTextBox(driver).sendKeys(
					Constant.CurrentPassword);
		} catch (Exception e) {
			System.out.println(e);
	...
	public void i_entered_a_valid_format_password_in_new_password_filed()
			throws Throwable {
		try {
			pageObjects.ChangePassword.EnterANewPasswordtextBox(driver)
					.sendKeys(Constant.NewPassword);
		} catch (Exception e) {
			System.out.println(e);
	...
	public void i_entered_same_text_in_re_type_new_password_field()
			throws Throwable {
		try {
			pageObjects.ChangePassword.RetypePasswordtextfield(driver)
					.sendKeys(Constant.NewPassword);
		} catch (Exception e) {
			System.out.println(e);
	...
	public void i_entered_incorrect_current_password() throws Throwable {
		...
		try {
			Assert.assertTrue(pageObjects.ChangePassword
					.CurrentPasswordTextBox(driver).isDisplayed());
			pageObjects.ChangePassword.CurrentPasswordTextBox(driver).sendKeys(
					Constant.ChangePasswordInvalid12);
		} catch (Exception e) {
			System.out.println(e);
	...
	public void given_valid_new_password() throws Throwable {
		...
		try {
			Assert.assertTrue(pageObjects.ChangePassword
					.EnterANewPasswordtextBox(driver).isDisplayed());
			pageObjects.ChangePassword.EnterANewPasswordtextBox(driver)
					.sendKeys(Constant.NewPassword);
		} catch (Exception e) {
	...
	public void entered_password_same_as_new_password_in_re_type_password_field()
		...
		try {
			Assert.assertTrue(pageObjects.ChangePassword
					.RetypePasswordtextfield(driver).isDisplayed());
			pageObjects.ChangePassword.RetypePasswordtextfield(driver)
					.sendKeys(Constant.NewPassword);
		} catch (Exception e) {
			System.out.println(e);
	...
	public void i_clicked_on_submit_button_without_filling_current_password_field()
		...
		try {
			Assert.assertTrue(pageObjects.ChangePassword
					.ChangePaaswordSubmiteButton(driver).isDisplayed());
			pageObjects.ChangePassword.ChangePaaswordSubmiteButton(driver)
					.click();
		} catch (Exception e) {
			System.out.println(e);
	...
	public void i_filled_Re_type_new_password_filled_with_different_data_which_is_not_new_password_data_in_text_box()
		...
		try {
			Assert.assertTrue(pageObjects.ChangePassword
					.RetypePasswordtextfield(driver).isDisplayed());
			pageObjects.ChangePassword.RetypePasswordtextfield(driver)
					.sendKeys(Constant.ChangePasswordInvalid13);
		} catch (Exception e) {
			System.out.println(e);
	...
	public void i_should_not_be_allowed_to_set_new_password() throws Throwable {
		try {
			...
			Assert.assertTrue(pageObjects.ChangePassword.FieldDoNotMatchError(
					driver).isDisplayed());
		} catch (Exception e) {
			System.out.println(e);
	...
	public void i_should_be_redirected_on_My_profile_page() throws Throwable {
		try {
			String actual = pageObjects.MyProfile.ProfilwHeading(driver)
					.getText();
	...
	public void i_should_see_This_field_is_required_error_text_for_available_all_fields()
			throws Throwable {
		try {
			Assert.assertTrue(pageObjects.ChangePassword
					.ThisFieldIsRewuiredError(driver).isDisplayed());
		} catch (Exception e) {
			System.out.println(e);
	...
	public void i_clicked_on_Submit_button_in_change_password_form()
			throws Throwable {
		try {
			Assert.assertTrue(pageObjects.ChangePassword
					.ChangePaaswordSubmiteButton(driver).isDisplayed());
	...
	public void i_should_be_able_to_change_my_password_with_confirmation_message_The_changes_were_saved_on_my_screen()
			throws Throwable {
		try {
			String actual = pageObjects.ChangePassword
					.ConfirmationMessageForChangePassword(driver).getText();
	...
	public void i_should_see_error_message_Your_current_password_is_incorrect()
			throws Throwable {
		try {
			Assert.assertTrue(pageObjects.ChangePassword.currentPasswordRong(
					driver).isDisplayed());
		} catch (Exception e) {
			System.out.println(e);
...
=======
	public void i_should_see_error_message_This_field_is_required_for_password_text_field()
			throws Throwable {
		try {
			ChangePassword.ThisFieldIsRewuiredError(driver).isDisplayed();
		} catch (Exception e) {
	...
	@Then("^I should see error message 'This field is required' for 'retype password' text field\\.$")
	public void i_should_see_error_message_This_field_is_required_for_retype_password_text_field()
			throws Throwable {
...
>>>>>>> f7041b28c0a973a7fbdfa55ea33609107a321e12
	...
	public void i_should_see_message_This_field_is_required_with_current_password_field()
			throws Throwable {
		try {
			Assert.assertTrue(pageObjects.ChangePassword
					.ThisFieldIsRewuiredError(driver).isDisplayed());
	...
	public void i_shouldsee_message_This_field_is_required_for_retype_password_field()
			throws Throwable {
		try {
			Assert.assertTrue(pageObjects.ChangePassword
					.ThisFieldIsRewuiredError(driver).isDisplayed());
	...
	public void i_should_message_Fields_do_not_match_for_Re_type_password_field()
			throws Throwable {
		try {
			Assert.assertTrue(pageObjects.ChangePassword.FieldDoNotMatchError(
					driver).isDisplayed());
	...
	public void i_click_on_Back_options() throws Throwable {
		try {
			Assert.assertTrue(pageObjects.ChangePassword
					.ChangePassWordBackButton(driver).isDisplayed());
	...
	public void i_enter_data_alfanumeric_jsd_under_Enter_new_password_text_field(
			int arg1) throws Throwable {
		try {
			Assert.assertTrue(pageObjects.ChangePassword
					.EnterANewPasswordtextBox(driver).isDisplayed());
			pageObjects.ChangePassword.EnterANewPasswordtextBox(driver)
					.sendKeys(Constant.ChangePasswordInvalid17);
			pageObjects.ChangePassword.ChangePaaswordSubmiteButton(driver)
					.click();
		} catch (Exception e) {
			System.out.println(e);
	...
	public void i_should_see_validation_message_Please_enter_a_password_that_is_at_least_six_characters_long_and_contains_at_least_one_special_characters_for_the_Enter_new_password_text_field()
			throws Throwable {
		try {
			Thread.sleep(1000);
			Assert.assertTrue(pageObjects.ChangePassword
					.WrongPassWordError(driver)
					.getText()
					.equalsIgnoreCase(
							"Password must be 6 chars with atleast 1 special char"));
		} catch (Exception e) {
			System.out.println(e);
	...
	public void i_enter_data_numeri_under_Enter_new_password_text_field(int arg1)
			throws Throwable {
		try {
			Assert.assertTrue(pageObjects.ChangePassword
					.EnterANewPasswordtextBox(driver).isDisplayed());
			pageObjects.ChangePassword.EnterANewPasswordtextBox(driver)
					.sendKeys(Constant.ChangePasswordInvalid1);
			pageObjects.ChangePassword.ChangePaaswordSubmiteButton(driver)
					.click();
		} catch (Exception e) {
			System.out.println(e);
	...
	public void i_enter_data_letterSpecial_shfk_under_Enter_new_password_text_field()
			throws Throwable {
		try {
			Assert.assertTrue(pageObjects.ChangePassword
					.EnterANewPasswordtextBox(driver).isDisplayed());
	...
	public void i_enter_data_numberSpecial_under_Enter_new_password_text_field(
			int arg1) throws Throwable {
		try {
			Assert.assertTrue(pageObjects.ChangePassword
					.EnterANewPasswordtextBox(driver).isDisplayed());
			...
			pageObjects.ChangePassword.EnterANewPasswordtextBox(driver)
					.sendKeys(Constant.ChangePasswordInvalid12);
			pageObjects.ChangePassword.ChangePaaswordSubmiteButton(driver)
					.click();
		} catch (Exception e) {
			System.out.println(e);
	...
	public void i_enter_data_less_letterSpacial_kjj_under_Enter_new_password_text_field()
			throws Throwable {
		try {
			Assert.assertTrue(pageObjects.ChangePassword
					.EnterANewPasswordtextBox(driver).isDisplayed());
			pageObjects.ChangePassword.EnterANewPasswordtextBox(driver).click();
			pageObjects.ChangePassword.EnterANewPasswordtextBox(driver)
					.sendKeys(Constant.ChangePasswordInvalid15);
			pageObjects.ChangePassword.ChangePaaswordSubmiteButton(driver)
					.click();
		} catch (Exception e) {
			System.out.println(e);
	...
	public void i_enter_data_lessAlfanumericSpeciala_b_under_Enter_new_password_text_field(
			int arg1) throws Throwable {
		try {
			Assert.assertTrue(pageObjects.ChangePassword
					.EnterANewPasswordtextBox(driver).isDisplayed());
			pageObjects.ChangePassword.EnterANewPasswordtextBox(driver).click();
			pageObjects.ChangePassword.EnterANewPasswordtextBox(driver)
					.sendKeys(Constant.ChangePasswordInvalid16);
			pageObjects.ChangePassword.ChangePaaswordSubmiteButton(driver)
					.click();
		} catch (Exception e) {
			System.out.println(e);
