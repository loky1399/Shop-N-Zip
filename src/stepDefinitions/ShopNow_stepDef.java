...
public class ShopNow_stepDef {
	...
	@Then("^I should be able to see  'Shop n Zip Deals' title with all the (\\d+)rd party links which are in tie-up with Shop N Zip$")
	...
	public void i_should_be_able_to_see_maximum(int arg1) throws Throwable {
		// Write code here that turns the phrase above into concrete actions
		throw new PendingException();
	}
