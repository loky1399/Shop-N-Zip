...
public class ForgotPassword_stepDef {
	...
	private String resetPasswordUrlFromEmailInbox = null;
	...
	public void i_clicked_on_Forgot_Password() throws Throwable {
		...
		try {
			pageObjects.SignIn.with_TFC_credentials_ForgotpasswordLink(driver)
					.click();
		} catch (Exception e) {
			System.out.println(e);
	...
	public void i_should_see_forgot_password_title_as_Forgot_Password()
		...
		try {
			...
			Assert.assertTrue(actual
					.equalsIgnoreCase("Shop n Zip - Forgot Password")
					&& pageObjects.ForgotPassword.forgotPasswordHeading(driver)
							.isDisplayed());
		} catch (Exception e) {
			System.out.println(e);
	...
	public void i_should_see_Email_address_field_with_water_mark_text_as_Email_Address()
		...
		try {
			String text = pageObjects.ForgotPassword
					.forgotPasswordEmailAddressTextBox(driver).getAttribute(
							"placeholder");
	...
	public void i_should_see_Reset_Password_button() throws Throwable {
		...
		try {
			Assert.assertTrue(pageObjects.ForgotPassword
					.forgotPassResetPasswordButton(driver).isDisplayed());
		} catch (Exception e) {
			System.out.println(e);
	...
	public void i_should_see_Reset_password_description_under_the_title_as_Recover_your_password_by_entering_the_email_address_associated_with_your_account_Check_your_email_for_the_instructions_on_how_to_reset_your_password()
		...
		try {
			String actual = pageObjects.ForgotPassword
					.forgotPasswordDescription(driver).getText();
	...
	public void i_entered_not_registered_email_id() throws Throwable {
		...
		try {
			pageObjects.ForgotPassword
					.forgotPasswordEmailAddressTextBox(driver).sendKeys(
							Constant.notRegisteredEmailId);
		} catch (Exception e) {
			System.out.println(e);
	...
	public void i_should_see_Please_enter_a_registered_e_mail_address_alert_message_on_my_screen()
			throws Throwable {

		try {

			Assert.assertTrue(pageObjects.ForgotPassword
					.forgotPasswod_EnterARegisteredEmaildErrorMessage(driver)
					.isDisplayed());
	...
	public void i_should_see_Invalid_email_address_error_message_on_my_screen()
			throws Throwable {

		try {
			Assert.assertTrue(pageObjects.ForgotPassword
					.forgotPasswod_EnterAValidEmailIdEroorMessage(driver)
					.isDisplayed());
		} catch (Exception e) {
			System.out.println(e);
	...
	public void i_should_see_confirmation_message_We_have_sent_a_link_to_reset_your_password_to_your_registered_e_mail_address_on_my_screen()
			throws Throwable {

		try {
			String actual = pageObjects.ForgotPassword
					.forgotPasswod_ConfirmationMessage(driver).getText();
			String expected = "We have sent a link to reset your password to your registered e-mail address";
			Assert.assertTrue(actual.contains(expected));
			// Assert.assertEquals(actual,
			// "We have sent a link to reset your password to your registered e-mail address","confirmation message is not displaying");
		} catch (Exception e) {
			System.out.println(e);
	...
	public void i_should_see_Reset_password_button_is_as_not_enabled()
			throws Throwable {
	...
	public void i_should_see_Enter_Your_New_Password_heading() throws Throwable {
		...
		try {
			String actual = pageObjects.ForgotPassword
					.forgotPassword_enteryournewpasswordheading(driver)
					.getText();
			Assert.assertEquals("Enter Your New Password", actual,
					"Heading is not matching for Enter Your New Password");
		} catch (Exception e) {
			System.out.println(e);
	...
	public void i_should_see_Password_text_field_in_reset_paswword_page()
			throws Throwable {

		try {

			Assert.assertTrue(pageObjects.ForgotPassword
					.forgotPassd_resetPasswordfield(driver).isDisplayed());

			String text = pageObjects.ForgotPassword
					.forgotPassd_resetPasswordfield(driver).getAttribute(
							"placeholder");
	...
	public void i_should_see_Retypepassword_text_fields() throws Throwable {
		...
		try {
			Assert.assertTrue(pageObjects.ForgotPassword
					.forgotPasswordReset_RetypePassword(driver).isDisplayed());

			String text = pageObjects.ForgotPassword
					.forgotPasswordReset_RetypePassword(driver).getAttribute(
							"placeholder");
	...
	public void i_enter_same_text_in_Retypepassword_text_field()
			throws Throwable {

		try {
			pageObjects.ForgotPassword.forgotPasswordReset_RetypePassword(
					driver).sendKeys(Constant.ResetPassword);
		} catch (Exception e) {
			System.out.println(e);
		}
	}
	...
	public void i_should_see_success_message_of_reset_password_Your_password_has_been_reset()
			throws Throwable {

		try {
			String actual = pageObjects.ForgotPassword
					.forgotPasswordYourpasswordhasbeenresetHeading(driver)
					.getText();
			System.out.println("******************************************"+actual);
			Assert.assertTrue(actual.contains("Your password has been reset."));
		} catch (Exception e) {
			System.out.println(e);
	...
	public void i_should_see_To_sign_in_with_your_new_password_click_here_for_sigin_with_shop_n_zip_site()
			throws Throwable {

		try {
			String actual = pageObjects.ForgotPassword
					.forgotPasswordTosigninclickhere(driver).getText();
			Assert.assertEquals(
					"To sign in with your new password, click here", actual);
		} catch (Exception e) {
			System.out.println(e);
	...
	public void i_click_on_To_sign_in_with_your_new_password_click_here_link()
			throws Throwable {

		try {
			Assert.assertTrue(pageObjects.ForgotPassword
					.forgotPasswordTosigninclickhereLink(driver).isDisplayed());
			String textlink = pageObjects.ForgotPassword
					.forgotPasswordTosigninclickhereLink(driver).getAttribute(
							"href");
			if (textlink == null) {
				Assert.fail("To sign in with your new password, click here is not clickable");
			}
			pageObjects.ForgotPassword.forgotPasswordTosigninclickhereLink(
					driver).click();
		} catch (Exception e) {
			System.out.println(e);
			Assert.fail("To sign in with your new password, click here is not clickable");
	...
	public void i_should_be_redirected_to_the_sigin_page_of_shop_n_zip_site()
			throws Throwable {
	...
	public void i_entered_valid_email_id() throws Throwable {
		...
		try {
			Assert.assertTrue(pageObjects.ForgotPassword
					.forgotPasswordEmailAddressTextBox(driver).isDisplayed());
			pageObjects.ForgotPassword
					.forgotPasswordEmailAddressTextBox(driver).sendKeys(
							Constant.RegistredEmailId);
		} catch (Exception e) {
			System.out.println(e);
	...
	public void i_click_on_Reset_Password_button() throws Throwable {
		...
		try {
			pageObjects.ForgotPassword.forgotPassResetPasswordButton(driver)
					.click();
		} catch (Exception e) {
			System.out.println(e);
	...
	public void i_should_be_redirected_to_Reset_Password_page()
		...
		try {
			String actual = driver.getTitle();
			Assert.assertEquals(actual, "Shop n Zip - Reset Password",
					"this is not reset password page");
		} catch (Exception e) {
			System.out.println(e);
	...
	public void i_should_see_Save_New_Password_button() throws Throwable {
		...
		try {
			...
			Assert.assertTrue(pageObjects.ForgotPassword.saveNewPasswordbutton(
					driver).isDisplayed());
	...
	public void i_should_see_Reset_password_title_as_Enter_your_new_Password()
		...
		try {
			Assert.assertTrue(pageObjects.ForgotPassword
					.saveNewPasswordHeading(driver).isDisplayed());
		} catch (Exception e) {
			System.out.println(e);
	...
	public void i_should_get_a_link_to_reset_the_password_to_my_email()
			throws Throwable {
		try {
			resetPasswordUrlFromEmailInbox = Utils.emailNotificationCheck();
		} catch (Exception e) {
			System.out.println(e);
			Assert.fail("failed to check email notificaiton is recieved or not");
		}
	}
	...
	public void i_confirm_my_email() throws Throwable {
		...
		driver.navigate().to(resetPasswordUrlFromEmailInbox);
	...
	public void i_should_be_able_to_see_Save_New_Password_button()
		...
		try {
			Assert.assertTrue(pageObjects.ForgotPassword
					.forgotPassword_savenewpassord(driver).isDisplayed());
			pageObjects.ForgotPassword.forgotPassword_savenewpassord(driver)
					.click();
		} catch (Exception e) {
			System.out.println(e);
			Assert.fail("Save new password button is not displaying");
	...
	public void i_should_get_reset_password_link_to_the_specified_email_address()
		...
		try{
			...
			System.out.println(e);
			Assert.fail("failed to check reset password email recieved or not");
		}
	}
	...
	public void i_clicked_on_the_link() throws Throwable {
		try {
			...
			System.out.println(e);
			Assert.fail("failed to click on reset password link in email");
	...
	public void i_enter_new_password() throws Throwable {
		...
		try {
			pageObjects.ForgotPassword.forgotPassd_resetPasswordfield(driver)
					.sendKeys(Constant.ResetPassword);
		} catch (Exception e) {
			System.out.println(e);
	...
	public void i_should_see_success_message_of_reset_password()
		...
		try {
			Assert.assertTrue(pageObjects.ForgotPassword
					.forgotPasswod_ConfirmationMessage(driver).getText()
					.equalsIgnoreCase("To sign in with your new password."));
		} catch (Exception e) {
			System.out.println(e);
	...
	public void i_Clicked_on_Reset_Password_button() throws Throwable {
		...
		try {
			String textlink = pageObjects.ForgotPassword
					.forgotPassResetPasswordButton(driver).getAttribute("type");
			if (textlink == null) {
				Assert.fail("To sign in with your new password, click here is not clickable");
			}
			pageObjects.ForgotPassword.forgotPassResetPasswordButton(driver)
	...
	public void i_should_see_a_validation_message_saying_email_address_field_is_required()
		...
		try {
			String actual = pageObjects.ForgotPassword
					.forgotPasswordErrormessage_ThisFiledIsrequired(driver)
					.getText();
	...
	public void i_entered_invalid_email_address() throws Throwable {
		...
		try {
			pageObjects.ForgotPassword
					.forgotPasswordEmailAddressTextBox(driver).sendKeys(
							Constant.InvalidEmailId);
			String relatederror = pageObjects.ForgotPassword
					.forgotPasswod_EnterAValidEmailIdEroorMessage(driver)
					.getText();
